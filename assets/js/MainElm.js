...
var $author$project$Main$Book = F6(
	function (name, rack, shelf, genre, note, subcategory) {
		return {genre: genre, name: name, note: note, rack: rack, shelf: shelf, subcategory: subcategory};
	});
...
var $author$project$Main$bookDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Main$Book,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'rack', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'shelf', $elm$json$Json$Decode$int),
	...
	$elm$json$Json$Decode$maybe(
		A2($elm$json$Json$Decode$field, 'subcategory', $elm$json$Json$Decode$string)));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$booksListDecoder = $elm$json$Json$Decode$list($author$project$Main$bookDecoder);
...
var $author$project$Main$getBooks = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotBooks, $author$project$Main$booksListDecoder),
		url: 'http://localhost:9292/books'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$Loading, $author$project$Main$getBooks);
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		var result = msg.a;
		if (result.$ === 'Ok') {
			var fullBooks = result.a;
			return _Utils_Tuple2(
				$author$project$Main$Success(fullBooks),
...
var $author$project$Main$colors = {
	...
	green: A3($mdgriffith$elm_ui$Element$rgb255, 32, 191, 85),
	lightBlue: A3($mdgriffith$elm_ui$Element$rgb255, 197, 232, 247),
	lightGrey: A3($mdgriffith$elm_ui$Element$rgb255, 224, 224, 224),
	orange: A3($mdgriffith$elm_ui$Element$rgb255, 242, 100, 25),
	red: A3($mdgriffith$elm_ui$Element$rgb255, 170, 0, 0),
...
var $author$project$Main$cellAttrs = F2(
	function (max, min) {
		return _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$Main$colors.darkCharcoal),
				...
				A2(
					...
					min,
					A2($mdgriffith$elm_ui$Element$maximum, max, $mdgriffith$elm_ui$Element$fill))),
...
var $author$project$Main$headerAttrs = _List_fromArray(
	[
		...
		$mdgriffith$elm_ui$Element$Border$color($author$project$Main$colors.blue)
	]);
...
var $author$project$Main$booksTable = function (books) {
	return A2(
							...
							columns: _List_fromArray(
								[
										...
										A2(
											...
											$mdgriffith$elm_ui$Element$width(
												A2(
													$mdgriffith$elm_ui$Element$minimum,
													345,
													A2($mdgriffith$elm_ui$Element$maximum, 345, $mdgriffith$elm_ui$Element$fill))),
											$author$project$Main$headerAttrs),
										$mdgriffith$elm_ui$Element$text('Name')),
									view: function (book) {
										return A2(
											$mdgriffith$elm_ui$Element$el,
											A2($author$project$Main$cellAttrs, 345, 345),
											$mdgriffith$elm_ui$Element$text(book.name));
									},
										...
										A2(
											...
											$mdgriffith$elm_ui$Element$width(
												A2(
													$mdgriffith$elm_ui$Element$minimum,
													170,
													A2($mdgriffith$elm_ui$Element$maximum, 170, $mdgriffith$elm_ui$Element$fill))),
											$author$project$Main$headerAttrs),
										$mdgriffith$elm_ui$Element$text('Genre')),
									view: function (book) {
										return A2(
											$mdgriffith$elm_ui$Element$el,
											A2($author$project$Main$cellAttrs, 170, 170),
											$mdgriffith$elm_ui$Element$text(book.genre));
									},
									width: $mdgriffith$elm_ui$Element$shrink
								},
									{
										...
										A2(
											...
											$mdgriffith$elm_ui$Element$width(
												A2(
													...
													A2($mdgriffith$elm_ui$Element$maximum, 170, $mdgriffith$elm_ui$Element$fill))),
											$author$project$Main$headerAttrs),
										$mdgriffith$elm_ui$Element$text('Subcategory')),
									view: function (book) {
										return A2(
											$mdgriffith$elm_ui$Element$el,
											A2($author$project$Main$cellAttrs, 170, 170),
											$mdgriffith$elm_ui$Element$text(
												A2($elm$core$Maybe$withDefault, '', book.subcategory)));
									},
									width: $mdgriffith$elm_ui$Element$shrink
								},
									{
									...
									view: function (book) {
										return A2(
											$mdgriffith$elm_ui$Element$el,
											A2($author$project$Main$cellAttrs, 340, 340),
											$mdgriffith$elm_ui$Element$text(
												A2($elm$core$Maybe$withDefault, '', book.note)));
									},
									width: $mdgriffith$elm_ui$Element$shrink
								},
									{
									header: A2(
										...
										A2(
											...
											$author$project$Main$headerAttrs),
										$mdgriffith$elm_ui$Element$text('Shelf')),
									view: function (book) {
										return A2(
											$mdgriffith$elm_ui$Element$el,
											A2($author$project$Main$cellAttrs, 90, 90),
											$mdgriffith$elm_ui$Element$text(
												$elm$core$String$fromInt(book.rack)));
									},
									width: $mdgriffith$elm_ui$Element$shrink
								},
									{
										...
										A2(
											...
											$mdgriffith$elm_ui$Element$width(
												A2(
													...
													A2($mdgriffith$elm_ui$Element$maximum, 90, $mdgriffith$elm_ui$Element$fill))),
											$author$project$Main$headerAttrs),
										$mdgriffith$elm_ui$Element$text('Rack')),
									view: function (book) {
										return A2(
											$mdgriffith$elm_ui$Element$el,
											A2($author$project$Main$cellAttrs, 90, 90),
											$mdgriffith$elm_ui$Element$text(
												$elm$core$String$fromInt(book.shelf)));
									},
									width: $mdgriffith$elm_ui$Element$shrink
								}
								]),
...
var $author$project$Main$footer = $mdgriffith$elm_ui$Element$text('Footer');
...
var $author$project$Main$header = A2(
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('Bibliotheca'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$alignRight]),
			$mdgriffith$elm_ui$Element$text('MenuButton'))
		]));
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Main$main_layout = function (state_layout) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[$author$project$Main$header, state_layout, $author$project$Main$footer])));
};
var $author$project$Main$view = function (model) {
	switch (model.$) {
		case 'Failure':
			return $author$project$Main$main_layout(
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_Nil,
					$mdgriffith$elm_ui$Element$text('I was unable to load your book.')));
		case 'Loading':
			return $author$project$Main$main_layout(
				A2(
					$mdgriffith$elm_ui$Element$el,
		...
		default:
			var fullBooks = model.a;
			return $author$project$Main$main_layout(
				$author$project$Main$booksTable(fullBooks));
	}
};
